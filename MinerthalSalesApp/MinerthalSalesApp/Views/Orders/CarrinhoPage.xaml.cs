...
public partial class CarrinhoPage : ContentPage
{
    ...
    private bool ValidarValorMaximo(decimal valorCombinado)
    {
        var valido = true;
        //VALOR
        var valorMaximo = model.ItemDeCalculoCarrinho.ValorBrutoProduto + model.ItemDeCalculoCarrinho.ValorDescontoMinimo;
        var valorMinimo = model.ItemDeCalculoCarrinho.ValorBrutoProduto - model.ItemDeCalculoCarrinho.ValorDescontoMaximo;
