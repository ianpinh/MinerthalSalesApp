...
namespace MinerthalSalesApp.Infra.Database.Base
{
	...
	{
		public const string DatabaseFilename = "minerthal.db3";
		private static string DbPath => Path.Combine(FileSystem.AppDataDirectory, DatabaseFilename);
		...
		public async Task<int> GetTotalAsync<TTable>() where TTable : class, new()
		{
